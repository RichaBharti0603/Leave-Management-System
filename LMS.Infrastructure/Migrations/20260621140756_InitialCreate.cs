        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountWeekends = table.Column<bool>(type: "boolean", nullable: false),
                    CountHolidays = table.Column<bool>(type: "boolean", nullable: false),
                    AttachmentRequiredIfDaysGte = table.Column<int>(type: "integer", nullable: false),
                    RequiresHrApproval = table.Column<bool>(type: "boolean", nullable: false),
                    BlackoutRulesJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeProfiles_EmployeeProfiles_ManagerEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Accrued = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveBalances_EmployeeProfiles_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalHistories_EmployeeProfiles_ApproverEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProfiles_ManagerEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_EmployeeId_StartDateTime_EndDateTime",
                table: "LeaveRequests",
